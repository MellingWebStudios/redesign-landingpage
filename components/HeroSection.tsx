...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      {/* Frosted Glass Gaussian Border Container */}
      <div className="relative z-10 w-full max-w-4xl mx-auto px-4">
        <div className="rounded-[18px] bg-background/90 px-6 py-12 md:py-5 flex flex-col items-center md:items-start">
          {/* Your hero content */}
          <motion.div
                ...
                >
                  <div className="flex items-center gap-1">
                    {Array.from({ length: 5 }).map((_, i) => (
                      ...
                      >
                        <Star fill="currentColor" stroke="none" className="h-4 w-4 text-primary" />
                      </motion.div>
                    ))}
                  </div>
