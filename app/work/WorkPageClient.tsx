      ...
      <div className="flex flex-wrap gap-3 mt-auto">
        ...
        {project.liveSiteUrl && (
          <a href={project.liveSiteUrl} target="_blank" rel="noopener noreferrer">
            <Button variant="outline">Live Site<ExternalLink className="ml-2 h-4 w-4" /></Button>
          </a>
        )}
      </div>
    </div>
  ...
  <div className="group bg-background border border-border rounded-xl overflow-hidden transition-all duration-300 hover:border-primary hover:shadow-md h-full flex flex-col">
    ...
    <div className="p-6 flex flex-col flex-grow">
      ...
      <div className="mt-auto">
        <Link href={`/work/${project.slug}`} className="text-primary hover:underline flex items-center text-sm font-medium">
    ...
    <>
        ...
        <div className="container-wide">
          ...
          <Reveal delay={0.1}>
            <p className="text-left text-muted-foreground text-xl max-w-3xl">
              Melling Web Studios builds lightning-fast, conversion-focused websites that drive real business results. Every project is designed, developed, and optimized in the UK by experts—never outsourced, never templated.
            </p>
          </Reveal>
        </div>
      </section>
      ...
      {featuredProjects.length > 0 && (
        <section className="py-16 bg-background">
          <div className="container-wide">
            <Reveal>
              <h2 className="text-3xl font-bold mb-12">Featured Client Success</h2>
            </Reveal>
      ...
      <section className="py-20 bg-primary text-white">
        <div className="container-wide text-center">
          <Reveal>
            <h2 className="mb-6 text-3xl font-bold">Free Website Redesign Consultation</h2>
          </Reveal>
          <Reveal delay={0.1}>
            <p className="text-white/80 max-w-2xl mx-auto mb-8 text-lg">
              See how your site could look, convert, and perform. Book your free audit—no hard sell, just expert insight and a preview of what's possible.
            </p>
          </Reveal>
          <Reveal delay={0.2}>
            <Link href="/contact">
              <Button className="btn btn-lg bg-white text-primary hover:bg-white/90">Book Your Audit</Button>
            </Link>
          </Reveal>
        </div>
      </section>
